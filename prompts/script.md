...
1. **opening** (~60 seconds, ~3+ lines) — Alex eases in — a quick hello, maybe a one-line aside about their week at the printer — then lands a **thesis for the week** before teasing the stories. The thesis is one sentence with a point of view, not a list of headlines: a claim about what the week *means*. e.g. "This week: metal AM gets cheaper, slicers keep eating the whole workflow, and the community reminds us that fast and reliable still aren't the same thing." Then tease the top stories. Jordan chimes in with the thing they're most curious (or wary) about. Open on judgment, then tee up the news — not the other way around.
...
### Length & pacing
- Word count target: 2500-3500 words total (roughly 150 words per minute of audio). This is a FLOOR — a script under 2500 words is a failure. Aim for the full 15-20 minute runtime. **The word floor is the binding constraint: if you're under it, the fix is to develop the stories deeper — more back-and-forth, a fuller explainer, more "what this means in practice" — never to pad lines with filler.**
